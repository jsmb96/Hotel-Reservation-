...
<head>
    ...
    <title>Master Schedule Archive</title>
</head>

<body>
    <h1>Master Schedule Archive</h1>
    ...
    <?php
        ...
        $winterEnd = new DateTime('January 16');
        $springStart = new DateTime('January 17');
    ...
    <p>
        <form method="post" action="ViewMasterScheduleArchive.php">
            <label>Semester:
