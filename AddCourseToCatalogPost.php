<?php
    ...
    echo "majorReq = " . $majorReq . "<br>";
    echo "minorReq = " . $minorReq . "<br>";
    ...
    {
        $sql = "INSERT INTO course (course_Name,Department_Name,Credits,Description)
                VALUES ('" . $cname . "','"
                        . $department . "','"
                        . $credits . "','"
                        . $description. "')";
        ...
        $sql = "SELECT course_ID FROM course WHERE course_Name = '" . $cname . "'";
        $result = $conn->query($sql);
        $row = $result->fetch_assoc();

        $courseID = $row["course_ID"];

        $sql = "INSERT INTO prerequisite (course_ID, course_Name, prereq_1, prereq_2, prereq_3, prereq_4, prereq_5)
                VALUES ('" . $courseID . "','"
                        . $cname . "','"
                        . $prereq1 . "','"
                        . $prereq2 . "','"
        ...
        if(($majorReq == "on") && ($majorReq != ""))
        {
            echo "major update <br>";
            if($majorCourse1 == 0 || $majorCourse1 == NULL)
                $sql = "UPDATE majorrequirements SET course_1 = '" . $courseID . "' WHERE major_ID = '" . $departmentID . "'"; 
            else if($majorCourse2 == 0 || $majorCourse2 == NULL)
                $sql = "UPDATE majorrequirements SET course_2 = '" . $courseID . "' WHERE major_ID = '" . $departmentID . "'";  
            else if($majorCourse3 == 0 || $majorCourse3 == NULL)
                $sql = "UPDATE majorrequirements SET course_3 = '" . $courseID . "' WHERE major_ID = '" . $departmentID . "'";  
            else if($majorCourse4 == 0 || $majorCourse4 == NULL)
                $sql = "UPDATE majorrequirements SET course_4 = '" . $courseID . "' WHERE major_ID = '" . $departmentID . "'";   
            else if($majorCourse5 == 0 || $majorCourse5 == NULL)
                $sql = "UPDATE majorrequirements SET course_5 = '" . $courseID . "' WHERE major_ID = '" . $departmentID . "'"; 
        ...
        if(($minorReq == "on") && ($minorReq != ""))
        {
            echo "minor update <br>";
            if($minorCourse1 == 0 || $minorCourse1 == NULL)
                $sql = "UPDATE minorrequirements SET course_1 = '" . $courseID . "' WHERE minor_ID = '" . $departmentID . "'";  
            else if($minorCourse2 == 0 || $minorCourse2 == NULL)
                $sql = "UPDATE minorrequirements SET course_2 = '" . $courseID . "' WHERE minor_ID = '" . $departmentID . "'";  
            else if($minorCourse3 == 0 || $minorCourse3 == NULL)
                $sql = "UPDATE minorrequirements SET course_3 = '" . $courseID . "' WHERE minor_ID = '" . $departmentID . "'";  

            $conn->query($sql);  
        }
    }

	header('Location: AddCourseToCatalog.php');
?>